...
//START 
//unsigned long long video_segment = 0L; /**< Segment Duration. Populated with value entered as argument -y:value >. Instead of duration, a file is currently being used*/
unsigned short numEncSymbPerPacket = 1L; /*< The number of symbols per packet. Populated with value entered as argument -Y:value. If zero, use input file to determine chunks to send >*/
